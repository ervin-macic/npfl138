...
def main(args: argparse.Namespace) -> None:
    ...
    pretrained_model = timm.create_model("tf_efficientnetv2_b0.in1k", pretrained=True, num_classes=0)
    ...
    output, features = efficientnetv2_b0.forward_intermediates()
    # TODO: Create the model and train it.
    model = Model(args, pretrained_model)
